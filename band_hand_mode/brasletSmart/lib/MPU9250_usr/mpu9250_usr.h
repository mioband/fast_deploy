#ifndef MPU9250_USR_H_
#define MPU9250_USR_H_
...
void MPU9250_writeReg16Bit(uint16_t Address, uint8_t Register, uint32_t value);
...
uint32_t MPU9250_readReg32Bit(uint16_t Address, uint8_t Register);
uint8_t MPU9250_readMulti(uint16_t Address, uint8_t Register, uint8_t * dst, uint8_t count);
